      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1 truncate">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-error-600 truncate dark:text-error-500">
              {name}
            </span>
          </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1 truncate">
          <div className="flex flex-col ">
            <span className="text-sm font-medium text-zinc-700 truncate dark:text-zinc-100">
              {name}
            </span>
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div className="h-2 w-full rounded-full bg-violet-600 dark:bg-violet-400" style={{ width: state === 'complete' ? '100%' : '80%' }} />
            </div>
